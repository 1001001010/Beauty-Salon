<x-primary-button data-modal-target="delete-modal-service-{{ $service->id }}"
    data-modal-toggle="delete-modal-service-{{ $service->id }}"
...
<!-- Модалка удаление услуги -->
<div id="delete-modal-service-{{ $service->id }}" tabindex="-1" aria-hidden="true"
    class="hidden overflow-y-auto overflow-x-hidden fixed h-full top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 max-h-full bg-black bg-opacity-25">
                ...
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-2 text-red-600 dark:text-red-500"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1  d="
                            M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0
                            011-1h4a1 1 0 011 1v3M4 7h16" />
                    </svg>
                    Удаление услуги
                </h3>
                <button type="button"
            ...
            <div class="p-6">
                <div class="mb-6 flex items-center">
                    <div class="mr-4 flex-shrink-0">
                        ...
                        @else
                            <div
                                class="h-16 w-16 rounded-lg bg-gray-100 dark:bg-gray-800 flex items-center justify-center">
                ...
                <div class="mb-6">
                    <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-red-900/20 dark:text-red-400"
                        ...
                        <div class="mt-1.5">Вы уверены, что хотите удалить услугу <br><b>"{{ $service->name }}"</b>?
                        </div>
                    </div>
                </div>
