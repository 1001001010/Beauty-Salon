<x-primary-button data-modal-target="crud-modal-master-2" data-modal-toggle="crud-modal-master-2">
    Редактировать
    </x-primaty-button>

    <!-- Main modal -->
    <div id="crud-modal-master-2" tabindex="-1" aria-hidden="true"
            ...
            <div
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button"
                        ...
                        data-modal-toggle="crud-modal-master-2">
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" method="post" action={{ route('master.update') }}
